...
public class InvoiceFragment extends ListFragment implements DbQueryCallback<Object> {
	...
	public void onActivityCreated(Bundle savedInstanceState) {
		...
		databaseQueryManager.getInvoices(Constants.DB_REQ_FETCH_INVOICES,this.activity.getCustomerId() , this);
	}
	...
	public void onQueryCompleted(int requestCode, Object object) {
		...
		case Constants.DB_REQ_FETCH_INVOICES:
			if(object!=null && object instanceof List)
			{
				...
				{
					setListAdapter(new ArrayAdapter<String>(getActivity(), android.R.layout.simple_list_item_1, invoiceList));
				}
			}
